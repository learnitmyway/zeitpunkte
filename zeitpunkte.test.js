...
test('1 minute for 2 days, phase start before day start, phase end after day end, GMT-12', () => {
  ...
  expect(actual).toEqual([
    new Date('Tue Aug 02 2020 20:00 GMT+0000'),
    new Date('Tue Aug 02 2020 20:01 GMT+0000'),
    new Date('Tue Aug 03 2020 20:00 GMT+0000'),
    new Date('Tue Aug 03 2020 20:01 GMT+0000'),
  ])
})
